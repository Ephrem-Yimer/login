    ...
    <section class="container wrapper">
      <h2 class="display-4 pt-3">Login</h2>
          ...
          <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
            ...
            <a class="btn btn-block btn-link bg-light" href="password_reset.php">forgot password</a>
           <!-- <p> <a href="password_reset.php">forgot password</a></p> -->
            <!-- <input type="reset" class="btn btn-block btn-outline-primary" value="Forgot password"> -->
